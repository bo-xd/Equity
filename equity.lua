...
function doAimassist()
	...
	local closestEntity = GetClosest(lib.flags["aimassist_range"])
	...
	local math.abs(yaw) > lib.flags["aimassist_angle_attach"]:Get() then return end
